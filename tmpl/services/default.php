...
/** @var \Joomla\Component\Hosting\Site\View\Services\HtmlView $this */
?>
...
<div class="container-fluid hosting-dashboard">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="alert alert-info alert-dismissible fade show nps-survey" role="alert">
                        ...
                        <div class="mt-3">
                            <div class="btn-group" role="group">
                                <?php for ($i = 0; $i <= 10; $i++): ?>
                                    ...
                                    <label class="btn btn-outline-light btn-sm" for="nps<?= $i ?>"><?= $i ?></label>
                                <?php endfor; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <h2 class="mb-3"><?php echo Text::_('COM_HOSTING_SERVICES_TITLE'); ?></h2>
